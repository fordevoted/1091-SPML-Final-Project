...
detail report can be found in report.pdf
work with [Darren Chen](https://github.com/tidarren)
...
- B (B to A ) test
- evaluate result
- but how to improve if evaluate fail?????
- Encoder + Unit + Decoder? 
- to introduce how to generate adversarial patch using GAN in traditional  

## Contact 
If you have any question, please contact me by sending email to 
